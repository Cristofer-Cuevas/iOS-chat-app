...
//    var filteredContacts:[Contact] {
//        return contacts.contacts.filter{searchText.isEmpty || $0.username.localizedStandardContains(searchText)}
//    }
    ...
    func updateFilteredContacts() {
            ...
            print("🔍 Filtered contacts updated: \(filteredContacts.map { $0.username })") // Debugging
        }
